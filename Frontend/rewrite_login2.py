...
start = content.find('  React.useEffect(()=>{')
if start == -1:
...
# Need to make sure I am replacing the FIRST useEffect, which is the Login one
# The login one ends right before handleLogin
content = content[:start] + login_use_effect + content[end + 3:]
