...
class Centre(Base):
    ...
    operating_status = Column(String(30), default="Open")
...
class Procurement(Base):
    ...
    grade = Column(String(10), nullable=True)  # 'A' or 'B'
    final_status = Column(String(30), default="Pending")
    procured_at = Column(DateTime, nullable=True)
    created_at = Column(DateTime, server_default=func.now())
...
class CropAdvisory(Base):
    ...
    selling_window = Column(String(100), nullable=True)
